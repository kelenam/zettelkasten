...
- Chaining isn't the most functional programming style of writing code, but we're going to see it as a lot of peole do do it in JavaScript this way, but then after that we will do the more clean, compartmentalized functional style.
