---
title: 📑 Intro | Hard Parts - Functional
date: 2020-03-18
...
## Contents
1. [Introduction]()
1. [JavaScript Principles Review](/hardparts-functional-js-principles)
1. [Higher Order Functions](/hardparts-functional-higher-order-functions)
1. [Map & Reduce](/hardparts-functional-map-and-reduce)
1. [Composition](/hardparts-functional-composition)
1. [Purity & Immutability](/hardparts-functional-purity-immutability)
1. [Closure](/hardparts-js-v2-closure)
1. [Function Decoration & Partial Application](/hardparts-functional-decoration-partial-application) 
...
---- 
- [NEXT → | JavaScript Principles Review](/hardparts-functional-js-principles)