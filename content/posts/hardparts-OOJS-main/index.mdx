...
3. [Prototype & new](/hardparts-OOJS-prototype-and-new)
4. [Scope & this](/hardparts-OOJS-scope-and-this)
5. [Default Prototype Chain]()
6. [Subclassing with Factory Functions]()
7. [Subclssing with new and call]()
8. [Subclassing with class, extends & super]() 
