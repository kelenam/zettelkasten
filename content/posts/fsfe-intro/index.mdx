...
- [Bash Basics](/fsfe-bash-basics)
- [Nginx Config Basics](/fsfe-nginx-config)
- [Security](/fsfe-security)
- [HTTP](/fsfe-http)
- [Containers Basics](/fsfe-containers-basics)
- [Saving Data](/fsfe-saving-data)
...
> [^ **What is a _shell_? What is a _terminal_? How do they differ?**]**Shell**: command interpreter to interface with system
