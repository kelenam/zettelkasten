...
### Table of Contents
1. [The Importance of Good Code](/the-importance-of-good-code)
2. [The State of JavaScript](/the-state-of-javascript)
3. [Managing Version History with Git](/managing-version-history-with-git)
