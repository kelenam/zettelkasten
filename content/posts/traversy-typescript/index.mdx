...
## Key Insights
- I'm not a bit unclear about interfaces, and using them with classes. On apperance, if I'm another dev, I can see the interface being a clear place to understand the class more quickly. However, it does redundant. 
