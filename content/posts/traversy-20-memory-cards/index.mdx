...
Handling rotation is down with a class `show-answer`, that will trigger our card to trigger its animation on the x axis and "flip". By adding the 180deg transform on our show-answer class, we're still going to have our 
