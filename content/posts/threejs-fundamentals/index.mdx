...
```html
<script type="module">
// Note, that we will be using the r113 provided from threejsfundamentals, and not the relative path way as if we had installed locally for the sake of this exercise
